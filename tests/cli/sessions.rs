...
fn dead_server_cli_reports_one_session_aware_json_line() {
    ...
    let stale = Command::new(env!("CARGO_BIN_EXE_brndr"))
...
fn integration_commands_run_locally_when_server_is_missing() {
    ...
    let workspace_list = Command::new(env!("CARGO_BIN_EXE_brndr"))
        .args(["workspace", "list"])
    ...
    let integration_install = Command::new(env!("CARGO_BIN_EXE_brndr"))
    ...
    let integration_status = Command::new(env!("CARGO_BIN_EXE_brndr"))
    ...
    let integration_uninstall = Command::new(env!("CARGO_BIN_EXE_brndr"))
