...
pub(crate) struct ClientShellConfig {
    ...
    pub(super) agent_panel_remotes: crate::config::AgentPanelRemotesConfig,
...
pub(super) struct ShellHitMap {
    ...
    pub(super) agent_remotes_toggle: Rect,
...
pub(crate) struct ClientShellState {
    ...
    pub(super) agent_panel_remotes_manual: bool,
...
impl ClientShellState {
    pub(crate) fn new(mut config: ClientShellConfig) -> Self {
        ...
        if let Some(remotes) = preferences.agent_panel_remotes {
            config.agent_panel_remotes = remotes;
        }
        ...
        Self {
            ...
            agent_panel_remotes_manual: preferences.agent_panel_remotes.is_some(),
