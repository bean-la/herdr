...
pub enum Method {
    ...
    #[serde(rename = "server.set_appearance")]
    ServerSetAppearance(ServerSetAppearanceParams),
    ...
    #[serde(rename = "pane.pin")]
    PanePin(PanePinParams),
    #[serde(rename = "pane.unpin")]
    PaneUnpin(PaneUnpinParams),
