...
use crate::api::schema::{
    ...
    PaneSendInputParams, PaneSendKeysParams, PaneSendTextParams, PanePinParams, PaneSplitParams,
    PaneSwapParams, PaneSwapReason, PaneSwapResult, PaneTarget, PaneUnpinParams, PaneZoomMode,
